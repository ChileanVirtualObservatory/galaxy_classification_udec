...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Y_u = [gr; ri; deVAB_r; expAB_r; lnLExp_r; lnLDeV_r; lnLStar_r; Conc_r; mRrCc_r; a_Er; mCr4_r; texture_r];

Y_salida = [espiral; eliptica; uncertain];

csvwrite('completobrillante_r.csv',Y_u');
