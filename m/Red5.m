...
%
%   adaptivemoments_r - input data.
%   salida - target data


%%%%%%%%%%%%%%%%%%%%%Carga de datos%%%%%%%%%%%%%%%%%%%%%%%%
%% Initialize variables.
filename = '\Prueba 5\adaptivemoments_r.csv';
delimiter = ',';
...
adaptivemomentsr = [dataArray{1:end-1}];
%% Clear temporary variables
clearvars filename delimiter formatSpec fileID dataArray ans;

%% Initialize variables.
filename = '\Prueba 5\salida.csv';
delimiter = ',';
...
for i=1:10      %%%Iteraciones de prueba
x = adaptivemomentsr';
t = salida';
